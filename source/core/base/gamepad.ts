...
import { GamePad, InputState } from "../interface.js";


export class BaseGamePad implements GamePad {
    ...
    public refreshGamepads() : void {
        ...
        this.activePad = pads[this.index ?? 0];
        this.checkButtons();
    }
    ...
    public getStick(index : number = 0) : Vector {
        
        if (index != 0) {

            throw new Error("Multi-stick gamepad not yet implemented...");
        }
        return this.leftStick.clone();
    }
